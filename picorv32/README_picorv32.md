...
# Important Note
This is a fork of the PicoRV32 code from https://github.com/cliffordwolf/picorv32.  Several modifications have been made here to suit the purposes of the course EE2003 Computer Organization at IIT Madras.  The original README file is retained below for completeness, but for up-to-date information, refer to the original documentation at the site above.

For questions regarding this modified version, contact Nitin Chandrachoodan <nitin@ee.iitm.ac.in>
